...
class Level():
    ...
    def getemptyposition(self):
        ...
        #def getpos_argentina():
            ...
            esq2 = scene.objects["esq2-1"].worldPosition
            esq5 = scene.objects["esq5-1"].worldPosition
            #print(esq2,esq5)
            x1=int(100*esq2[0])+25
            x2=int(100*esq5[0])-25
            y1=int(100*esq2[1])+25
            y2=int(100*esq5[1])+25
            #print("---------------------------------",x1,x2,y1,y2)
            x= random.randrange(x1,x2)
            y= random.randrange(y2,y1)
            pos = mathutils.Vector((x/100, y/100, 0))
            return pos
